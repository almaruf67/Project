            ...
            <div class="search-chart-box px-5">
              <div class="input-group">
                <div class="id-semester-display">
                  <input type="number" class="form-control searchbox" placeholder="Enter ID" style="width: 50%; border-radius: 5px 5px 5px 5px" />

                  <select class="form-select dropdown-btn-student" aria-label="Default select example">
